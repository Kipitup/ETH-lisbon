...
export class AgentPermit extends ethereum.Event {
  get params(): AgentPermit__Params {
    return new AgentPermit__Params(this);
  }
}

export class AgentPermit__Params {
  _event: AgentPermit;

  constructor(event: AgentPermit) {
    this._event = event;
  }
...
export class BorrowRefferal extends ethereum.Event {
  get params(): BorrowRefferal__Params {
    return new BorrowRefferal__Params(this);
  }
}

export class BorrowRefferal__Params {
  _event: BorrowRefferal;

  constructor(event: BorrowRefferal) {
    this._event = event;
  }
...
export class ERC20Approve extends ethereum.Event {
  get params(): ERC20Approve__Params {
    return new ERC20Approve__Params(this);
  }
}

export class ERC20Approve__Params {
  _event: ERC20Approve;

  constructor(event: ERC20Approve) {
    this._event = event;
  }
...
export class ERC721Approve extends ethereum.Event {
  get params(): ERC721Approve__Params {
    return new ERC721Approve__Params(this);
  }
}

export class ERC721Approve__Params {
  _event: ERC721Approve;

  constructor(event: ERC721Approve) {
    this._event = event;
  }
...
export class ExecuteInterceptor extends ethereum.Event {
  get params(): ExecuteInterceptor__Params {
    return new ExecuteInterceptor__Params(this);
  }
}

export class ExecuteInterceptor__Params {
  _event: ExecuteInterceptor;

  constructor(event: ExecuteInterceptor) {
    this._event = event;
  }
...
export class FlashExecute extends ethereum.Event {
  get params(): FlashExecute__Params {
    return new FlashExecute__Params(this);
  }
}

export class FlashExecute__Params {
  _event: FlashExecute;

  constructor(event: FlashExecute) {
    this._event = event;
  }
...
export class ServiceFee extends ethereum.Event {
  get params(): ServiceFee__Params {
    return new ServiceFee__Params(this);
  }
}

export class ServiceFee__Params {
  _event: ServiceFee;

  constructor(event: ServiceFee) {
    this._event = event;
  }
...
export class UpdageInterceptor extends ethereum.Event {
  get params(): UpdageInterceptor__Params {
    return new UpdageInterceptor__Params(this);
  }
}

export class UpdageInterceptor__Params {
  _event: UpdageInterceptor;

  constructor(event: UpdageInterceptor) {
    this._event = event;
  }
...
export class XY3V2__borrowInput_offerStruct extends ethereum.Tuple {
  get borrowAmount(): BigInt {
    return this[0].toBigInt();
  }
...
export class XY3V2__borrowInput_lenderSignatureStruct extends ethereum.Tuple {
  get nonce(): BigInt {
    return this[0].toBigInt();
  }
...
export class XY3V2__borrowInput_brokerSignatureStruct extends ethereum.Tuple {
  get nonce(): BigInt {
    return this[0].toBigInt();
  }
...
export class XY3V2__borrowInput_extraDealStruct extends ethereum.Tuple {
  get target(): Address {
...
export class XY3V2__getLoanStateResultValue0Struct extends ethereum.Tuple {
  get xy3NftId(): BigInt {
    return this[0].toBigInt();
  }
...
export class XY3V2__loanDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class XY3V2 extends ethereum.SmartContract {
  static bind(address: Address): XY3V2 {
    return new XY3V2("XY3V2", address);
  }
  ...
  borrow(
    _offer: XY3V2__borrowInput_offerStruct,
    _nftId: BigInt,
    _isCollectionOffer: boolean,
    _lenderSignature: XY3V2__borrowInput_lenderSignatureStruct,
    _brokerSignature: XY3V2__borrowInput_brokerSignatureStruct,
    _extraDeal: XY3V2__borrowInput_extraDealStruct
  ): BigInt {
    let result = super.call(
      "borrow",
      "borrow((uint256,uint256,address,uint32,address,uint256,bytes),uint256,bool,(uint256,uint256,address,bytes),(uint256,uint256,address,bytes),(address,bytes4,bytes,uint256)):(uint32)",
      [
        ethereum.Value.fromTuple(_offer),
        ethereum.Value.fromUnsignedBigInt(_nftId),
        ethereum.Value.fromBoolean(_isCollectionOffer),
        ethereum.Value.fromTuple(_lenderSignature),
        ethereum.Value.fromTuple(_brokerSignature),
        ethereum.Value.fromTuple(_extraDeal)
      ]
    );
  ...
  try_getAddressProvider(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getAddressProvider",
      "getAddressProvider():(address)",
      []
  ...
  getAgentPermit(_agent: Address, _selector: Bytes): boolean {
    let result = super.call(
      "getAgentPermit",
      "getAgentPermit(address,bytes4):(bool)",
      [
        ethereum.Value.fromAddress(_agent),
  ...
  getInterceptors(
    ...
    let result = super.call(
      "getInterceptors",
      "getInterceptors(uint256,address,uint256):(address[])",
      [
        ethereum.Value.fromUnsignedBigInt(_queueId),
        ethereum.Value.fromAddress(nftAsset),
  ...
  getLoanState(_loanId: BigInt): XY3V2__getLoanStateResultValue0Struct {
    let result = super.call(
      "getLoanState",
    ...
    return changetype<XY3V2__getLoanStateResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getLoanState(
    _loanId: BigInt
  ): ethereum.CallResult<XY3V2__getLoanStateResultValue0Struct> {
    let result = super.tryCall(
      "getLoanState",
      "getLoanState(uint32):((uint64,uint8))",
      [ethereum.Value.fromUnsignedBigInt(_loanId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<XY3V2__getLoanStateResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  loanDetails(param0: BigInt): XY3V2__loanDetailsResult {
    let result = super.call(
      "loanDetails",
      "loanDetails(uint32):(uint256,uint256,uint256,address,uint32,uint16,uint64,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new XY3V2__loanDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_loanDetails(
    param0: BigInt
  ): ethereum.CallResult<XY3V2__loanDetailsResult> {
    let result = super.tryCall(
      "loanDetails",
      "loanDetails(uint32):(uint256,uint256,uint256,address,uint32,uint16,uint64,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  loanIds(param0: Address, param1: BigInt): BigInt {
    let result = super.call("loanIds", "loanIds(address,uint256):(uint32)", [
  ...
  try_loanIds(param0: Address, param1: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("loanIds", "loanIds(address,uint256):(uint32)", [
      ethereum.Value.fromAddress(param0),
      ethereum.Value.fromUnsignedBigInt(param1)
    ]);
    if (result.reverted) {
...
export class AddInterceptorCall extends ethereum.Call {
  get inputs(): AddInterceptorCall__Inputs {
    return new AddInterceptorCall__Inputs(this);
  }

  get outputs(): AddInterceptorCall__Outputs {
    return new AddInterceptorCall__Outputs(this);
  }
}

export class AddInterceptorCall__Inputs {
  _call: AddInterceptorCall;

  constructor(call: AddInterceptorCall) {
    this._call = call;
  }
...
export class AddInterceptorCall__Outputs {
  _call: AddInterceptorCall;
...
export class AdminClaimErc1155Call extends ethereum.Call {
  get inputs(): AdminClaimErc1155Call__Inputs {
    return new AdminClaimErc1155Call__Inputs(this);
  }

  get outputs(): AdminClaimErc1155Call__Outputs {
    return new AdminClaimErc1155Call__Outputs(this);
  }
}

export class AdminClaimErc1155Call__Inputs {
  _call: AdminClaimErc1155Call;

  constructor(call: AdminClaimErc1155Call) {
    this._call = call;
  }
...
export class AdminClaimErc1155Call__Outputs {
  _call: AdminClaimErc1155Call;
...
export class AdminClaimErc20Call extends ethereum.Call {
  get inputs(): AdminClaimErc20Call__Inputs {
    return new AdminClaimErc20Call__Inputs(this);
  }

  get outputs(): AdminClaimErc20Call__Outputs {
    return new AdminClaimErc20Call__Outputs(this);
  }
}

export class AdminClaimErc20Call__Inputs {
  _call: AdminClaimErc20Call;

  constructor(call: AdminClaimErc20Call) {
    this._call = call;
  }
...
export class AdminClaimErc20Call__Outputs {
  _call: AdminClaimErc20Call;
...
export class AdminClaimErc721Call extends ethereum.Call {
  get inputs(): AdminClaimErc721Call__Inputs {
    return new AdminClaimErc721Call__Inputs(this);
  }

  get outputs(): AdminClaimErc721Call__Outputs {
    return new AdminClaimErc721Call__Outputs(this);
  }
}

export class AdminClaimErc721Call__Inputs {
  _call: AdminClaimErc721Call;

  constructor(call: AdminClaimErc721Call) {
    this._call = call;
  }
...
export class AdminClaimErc721Call__Outputs {
  _call: AdminClaimErc721Call;
...
export class BorrowCall__Inputs {
  ...
  get _extraDeal(): BorrowCall_extraDealStruct {
    return changetype<BorrowCall_extraDealStruct>(
...
export class BorrowCall_extraDealStruct extends ethereum.Tuple {
  get target(): Address {
    return this[0].toAddress();
  }
...
export class DeleteInterceptorCall extends ethereum.Call {
  get inputs(): DeleteInterceptorCall__Inputs {
    return new DeleteInterceptorCall__Inputs(this);
  }

  get outputs(): DeleteInterceptorCall__Outputs {
    return new DeleteInterceptorCall__Outputs(this);
  }
}

export class DeleteInterceptorCall__Inputs {
  _call: DeleteInterceptorCall;

  constructor(call: DeleteInterceptorCall) {
    this._call = call;
  }
...
export class DeleteInterceptorCall__Outputs {
  _call: DeleteInterceptorCall;
...
export class FlashExecuteCall extends ethereum.Call {
  get inputs(): FlashExecuteCall__Inputs {
    return new FlashExecuteCall__Inputs(this);
  }

  get outputs(): FlashExecuteCall__Outputs {
    return new FlashExecuteCall__Outputs(this);
  }
}

export class FlashExecuteCall__Inputs {
  _call: FlashExecuteCall;

  constructor(call: FlashExecuteCall) {
    this._call = call;
  }
...
export class FlashExecuteCall__Outputs {
  _call: FlashExecuteCall;
...
export class PurgeInterceptorCall extends ethereum.Call {
  get inputs(): PurgeInterceptorCall__Inputs {
    return new PurgeInterceptorCall__Inputs(this);
  }

  get outputs(): PurgeInterceptorCall__Outputs {
    return new PurgeInterceptorCall__Outputs(this);
  }
}

export class PurgeInterceptorCall__Inputs {
  _call: PurgeInterceptorCall;

  constructor(call: PurgeInterceptorCall) {
    this._call = call;
  }
...
export class PurgeInterceptorCall__Outputs {
  _call: PurgeInterceptorCall;
...
export class SetAgentPermitsCall extends ethereum.Call {
  get inputs(): SetAgentPermitsCall__Inputs {
    return new SetAgentPermitsCall__Inputs(this);
  }

  get outputs(): SetAgentPermitsCall__Outputs {
    return new SetAgentPermitsCall__Outputs(this);
  }
}

export class SetAgentPermitsCall__Inputs {
  _call: SetAgentPermitsCall;

  constructor(call: SetAgentPermitsCall) {
    this._call = call;
  }

  get _agents(): Array<Address> {
...
export class SetAgentPermitsCall__Outputs {
  _call: SetAgentPermitsCall;
